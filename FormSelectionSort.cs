...
{
    public partial class FormSelectionSort : Form
    {
        private List<ProductoColasCirculares> productos;
        public FormSelectionSort()
        {
            InitializeComponent();
            this.Load += FormSelectionSort_Load;
            productos = new List<ProductoColasCirculares>();
        }

        private void FormSelectionSort_Load(object sender, EventArgs e)
        {
        ...
        private void btnAscendente_Click(object sender, EventArgs e)
        {
            ...
            if (cbCriterio.SelectedItem != null)
            {
                ...
                SelectionSort.Ordenar(productos, criterio, true); // Orden ascendente
                ActualizarDataGridView();
            }
            else
            {
        ...
        private void btnDescendente_Click(object sender, EventArgs e)
        {
            ...
            {
                string criterio = cbCriterio.SelectedItem.ToString();
                SelectionSort.Ordenar(productos, criterio, false); // Orden descendente
                ActualizarDataGridView();
            }
            else
            {
