...
namespace ProyectoFinalEstructuraDatosGrupo4
{
    public partial class FormShellSort : Form
    {
        ...
        {
            InitializeComponent();
            this.Load += FormShellSort_Load;
            productos = new List<ProductoColasCirculares>();
        }

        private void FormShellSort_Load(object sender, EventArgs e)
        {
        ...
        private void btnAscendente_Click(object sender, EventArgs e)
        {
            ...
            if (cbCriterio.SelectedItem != null)
            {
                ...
                ShellSort.Ordenar(productos, criterio, true); // Orden ascendente usando ShellSort
                ActualizarDataGridView();
            }
            else
            {
        ...
        private void btnDescendente_Click(object sender, EventArgs e)
        {
            ...
            {
                string criterio = cbCriterio.SelectedItem.ToString();
                ShellSort.Ordenar(productos, criterio, false); // Orden descendente usando ShellSort
                ActualizarDataGridView();
            }
            else
            {
